dt= [
    ...
    ["Дніпрянка", 'Машини та обладнання', 10087, 15972, 58, 26001, 15914],
    ...
    ["Універсам 22", 'Машини та обладнання', 5564, 2571, 135, 8000, 2436],
    ["Універсам 22", 'Транспортні засоби', 12, 33, 3, 42, 30],
    ["Універсам 22", 'Інструменти та інвентар', 116, 64, 23, 157, 41],
]